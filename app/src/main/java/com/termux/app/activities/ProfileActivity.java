...
/**
 * Account profile screen: shows the Google account details (name, email,
 * photo) and lets the user edit a local username and bio.
 */
public class ProfileActivity extends AppCompatActivity {
    ...
    private void bindAccount() {
        ...
        mSignedInAtView.setText(signedInAt > 0
            ? DateFormat.getDateFormat(this).format(signedInAt) + " " +
              DateFormat.getTimeFormat(this).format(signedInAt)
